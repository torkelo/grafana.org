...
!*/
define(["Modernizr","docElement","createElement","testStyles","hasEvent"],function(t,e,o,n,s){t.addTest("oninput",function(){var t,n=o("input");if(n.setAttribute("oninput","return"),s("oninput",e)||"function"==typeof n.oninput)return!0;try{var i=document.createEvent("KeyboardEvent");t=!1;var p=function(e){t=!0,e.preventDefault(),e.stopPropagation()};i.initKeyEvent("keypress",!0,!0,window,!1,!1,!1,!1,0,"e".charCodeAt(0)),e.appendChild(n),n.addEventListener("input",p,!1),n.focus(),n.dispatchEvent(i),n.removeEventListener("input",p,!1),e.removeChild(n)}catch(r){t=!1}return t})});